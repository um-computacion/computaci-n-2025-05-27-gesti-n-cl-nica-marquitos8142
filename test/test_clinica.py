...
class TestClinica(unittest.TestCase):
    ...
    def _proximo_dia_a_las_1430(self, dia_semana: str):
        ...
        if dias_a_sumar == 0 and (hoy.hour > 14 or (hoy.hour == 14 and hoy.minute >= 30)):
            dias_a_sumar = 7
    ...
    def test_agendar_turno_exitoso(self):
        ...
        self.clinica.agendar_turno("87654321", "MAT99999", "Pediatría", self.fecha_lunes)
    ...
    def test_error_turno_fecha_pasada(self):
        ...
        with self.assertRaises(ValueError) as context:
            self.clinica.agendar_turno("87654321", "MAT99999", "Pediatría", fecha_pasada)
    ...
    def test_error_turno_paciente_inexistente(self):
        ...
        with self.assertRaises(ElPacienteNoExisteException):
            self.clinica.agendar_turno("00000000", "MAT99999", "Pediatría", self.fecha_lunes)
    
    def test_error_turno_medico_inexistente(self):
        self.clinica.agregar_paciente(self.paciente1)
        
        with self.assertRaises(ElMedicoNoExisteException):
            self.clinica.agendar_turno("87654321", "MAT00000", "Pediatría", self.fecha_lunes)
    ...
    def test_error_medico_no_trabaja_ese_dia(self):
        ...
        with self.assertRaises(MedicoNoDisponibleException):
            self.clinica.agendar_turno("87654321", "MAT99999", "Pediatría", fecha_martes)
    ...
    def test_emitir_receta(self):
        ...
        self.clinica.emitir_receta("87654321", "MAT99999", ["Ibuprofeno 200mg", "Rubifem 20mg"])
